...
function buildProduct(
  ...
  return {
    ...
    position,
    pageNumber,
    nameElement: nameItem ? { ...toTextElement(nameItem), textColor: claude.textColor ?? { r: 0, g: 0, b: 0 } } : undefined,
    descriptionElement: descItem ? { ...toTextElement(descItem), textColor: claude.textColor ?? { r: 0, g: 0, b: 0 } } : undefined,
    priceElement: priceItem ? { ...toTextElement(priceItem), textColor: claude.textColor ?? { r: 0, g: 0, b: 0 } } : undefined,
    salePriceElement: salePriceItem ? { ...toTextElement(salePriceItem), textColor: claude.textColor ?? { r: 0, g: 0, b: 0 } } : undefined,
